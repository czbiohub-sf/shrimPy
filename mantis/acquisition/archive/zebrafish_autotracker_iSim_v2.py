...
#%%
data_directory = r'C:\\Users\\ZebraPhysics\Documents\\2022_09_30_zebrafish_imaging'
        ...
        if z_index == len(z_range)-1:
            ...
            if channel == epi_channels[-1]['config']:
                ...
                if time_index > 0:
                    ...
                    ref_stack = block_avg(rescale_image(np.stack(img_process_fn.ref_images[p_idx])), n=block_avg_window)
