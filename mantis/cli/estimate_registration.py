...
def manual_registration(channel_1_data_path, channel_2_data_path, output_file):
    ...
    print(f"Affine Transform Matrix:\n {zyx_points_transformation_matrix}\n")
    ...
    if flag_estimate_3D_transform == "Y" or flag_estimate_3D_transform == "y":
        ...
        with open_ome_zarr(
            ...
            img = position.create_zeros(
                name="0",
                shape=(1, 1, channel_2_Z, channel_2_Y, channel_2_X),
                chunks=(1, 1, channel_2_Z, channel_2_Y, channel_2_X),
                dtype=np.uint16,
            )
