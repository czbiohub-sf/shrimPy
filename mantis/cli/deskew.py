...
def get_deskew_params(deskew_params_path):
    # Load params
...
def create_empty_zarr(position_paths, deskew_params_path, output_path, keep_overhang):
    ...
    settings = get_deskew_params(deskew_params_path)
...
def deskew(
    input_data_path, deskew_param_path, output_path, view, keep_overhang, num_cores
):
