...
def get_deskew_params(deskew_param_path):
    # Load params
...
def create_empty_zarr(position_paths, deskew_param_path, output_path, keep_overhang):
...
def get_output_paths(list_pos, output_path):
...
def deskew_cli(
    input_data_path, output_path, deskew_param_path, keep_overhang, num_cores
):
    """
...
def deskew(
    input_data_path, deskew_param_path, output_path, keep_overhang, num_cores
):
    ...
    deskew_params = (deskew_param_path, keep_overhang, num_cores)
