...
@click.option(
    ...
    default='/hpc/scratch/group.comp.micro/',
    help="Path to temporary directory, ideally with fast read/write speeds.",
)
...
def stitch(
    ...
    >>> mantis stitch -i ./input.zarr/*/*/* -c ./stitch_params.yml -o ./output.zarr --slurm
    """
    if not slurm:
