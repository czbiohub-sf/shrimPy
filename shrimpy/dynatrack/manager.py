...
class DynaTrack:
    ...
    def from_config(
        ...
        section as a :class:`DynaTrackConfig` from
        :class:`shrimpy.config.ShrimpyConfig`. The XY pixel size and Z step are
        derived here (see :meth:`from_metadata`) and injected into the
    ...
    def from_metadata(
        ...
        ----------
        meta : dict | None
            The ``dynatrack`` config section, mapping directly onto
