...
from shrimpy.acquisition.AcquisitionSettings import AutoexposureSettings
from shrimpy.acquisition.autoexposure import manual_autoexposure, mean_intensity_autoexposure
...
def acquire_ls_defocus_stack_and_display(
    ...
    """Utility function similar to shrimpyAcquisition.acquire_ls_defocus_stack
