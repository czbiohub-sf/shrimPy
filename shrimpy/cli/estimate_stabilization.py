...
from shrimpy.cli.parsing import input_position_dirpaths, output_filepath
from shrimpy.cli.utils import model_to_yaml
...
def estimate_stabilization(
    ...
    Example usage:
    shrimpy stabilization -i ./timelapse.zarr/0/0/0 -o ./stabilization.yml -y -z -v --crop-size-xy 300 300
