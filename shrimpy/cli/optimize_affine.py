...
from shrimpy.analysis.register import convert_transform_to_ants, convert_transform_to_numpy
from shrimpy.cli.parsing import (
    config_filepath,
    output_filepath,
    source_position_dirpaths,
    target_position_dirpaths,
)
from shrimpy.cli.utils import model_to_yaml, yaml_to_model
...
def optimize_affine(
    ...
    shrimpy optimize-affine -s ./acq_name_virtual_staining_reconstructed.zarr/0/0/0 -t ./acq_name_lightsheet_deskewed.zarr/0/0/0 -c ./transform.yml -o ./optimized_transform.yml -d -v
    """
