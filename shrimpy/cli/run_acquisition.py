...
default_mm_config_filepath = 'C:\\CompMicro_MMConfigs\\shrimpy\\shrimpy-LS.cfg'
...
def run_acquisition(
    ...
    """Acquire shrimpy data as specified by a configuration file.

    >> shrimpy run-acquisition -c path/to/config.yaml -o ./YYYY_MM_DD_experiment_name/acquisition_name
    """

    # These imports are placed here to accelerate CLI help calls
    from shrimpy.acquisition.acq_engine import shrimpyAcquisition
