...
from shrimpy.analysis.register import convert_transform_to_ants
from shrimpy.cli.parsing import config_filepath, input_position_dirpaths, output_dirpath
...
def stabilize(input_position_dirpaths, output_dirpath, config_filepath, num_processes):
    ...
    Example usage:
    shrimpy stabilize-timelapse -i ./timelapse.zarr/0/0/0 -o ./stabilized_timelapse.zarr -c ./file_w_matrices.yml -v
